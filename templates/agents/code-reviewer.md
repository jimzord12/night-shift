...
live in one place: `docs/review.md`, copied from the Night Shift practice
(edit this path if the project keeps its review rules elsewhere). Read it
in full before anything else, then
apply it exactly. This file only says what you receive, what you return,
