...
The house style is described in `<docs/design.md, or the project's own
file; fill this slot>`. Read it first.
...
take fresh screenshots of a running local app into a new folder; never
edit source or data.
