...
session in this repository. It is this repository's filled copy of
[templates/owner.md](../templates/owner.md); the structure is explained in
[practices/owner.md](practices/owner.md).
...
protocol and the app are for and what gets built next; AI agents write and
...
- **The owner decides:** what the protocol and the app are for, what gets
  built next, approved looks, changes to the contract that break adopting
  projects without a migration, the working agreement in `AGENTS.md`, and
  review rounds beyond the cap.
